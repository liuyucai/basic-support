 ...
 */
@Data
@PropertySource(value = "classpath:/sql/roleResource-sql.yml", factory = YamlPropertySourceFactory.class)
@Configuration
@ConfigurationProperties(prefix = "role-resource")
public class RoleResourceSqlConfig {
