...
@ToString
@Entity
@Table ( name ="oauth_client_menu1" )
public class ClientMenu1 extends BaseEntity<String> implements Serializable {

	private static final long serialVersionUID =  2574485447710689662L;
